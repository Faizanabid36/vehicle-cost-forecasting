@extends('layouts.app')
{{-- Title Section --}}
@section('title','Edit Warehouse Details')
...
@section('content')
		<div class="container row">
			...
			<header class="special">
	            <h1>Edit the Warehouse Details</h1>
	          </header>
			</div>
		</div>
{{-- 		???????????????????? --}}
		<form method="post" action="{{ action('WarehouseController@update',$warehouseE->id) }}">
			<div>
			    <div class="" style="width: 60%;margin: 0px auto;">

			        <!--Body-->
			        <div class="md-form">
			            <input value="{{ $warehouseE->w_name }}" name="w_name" type="text" id="form2" class="form-control text-white">
			        ...
			        <div class="md-form">
			            <input value="{{ $warehouseE->w_location }}" name="w_location" type="text" id="form4" class="form-control text-white">
			        ...
			        <div class="md-form">
			            <input value="{{ $warehouseE->storage }}" name="storage" type="number" id="form4" class="form-control text-white">
			            <label for="form4">Storage Available</label>
